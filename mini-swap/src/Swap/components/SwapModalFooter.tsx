...
import { Button, Text, AutoRenewIcon } from 'pancake-uikit'
      ...
      <SwapModalFooterContainer>
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper placement="top-start" text={t("The difference between the market price and your price due to trade size.")} ml="4px" />
          </RowFixed>
