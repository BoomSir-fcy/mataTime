...
import { SWAP_TOKEN, JSBI, Percent, Router, SwapParameters, Trade, TradeType } from 'dsgswap-sdk'
...
function useSwapCallArguments(
  ...
  return useMemo(() => {
    ...
    let isDsgFrom = false
    if (SWAP_TOKEN[chainId]?.address === (trade?.inputAmount?.currency as any)?.address && trade.tradeType === TradeType.EXACT_OUTPUT) {
      isDsgFrom = true
    }
    const swapMethods = []
    swapMethods.push(
