import { Currency, currencyEquals, ETHER, getValueWithChainId, WETHER } from 'dsgswap-sdk'
...
export default function useWrapCallback(
  ...
  const wEther = getValueWithChainId(WETHER)
      ...
      return {
        ...
        execute:
          sufficientBalance && inputAmount
            ? async () => {
                try {
                  ...
                  addTransaction(txReceipt, { summary: t(`Wrap %amoun% %symbolA% to %symbolB%`, {
                    ...
                    symbolA: wEther?.symbol,
                    symbolB: ETHER?.symbol,
                  }) })
                } catch (error) {
            ...
            : undefined,
        inputError: sufficientBalance ? undefined : t('Insufficient %symbol% balance', { symbol: ETHER.symbol }),
      }
    }
      ...
      return {
        ...
        execute:
          sufficientBalance && inputAmount
            ...
            : undefined,
        inputError: sufficientBalance ? undefined : t('Insufficient %symbol% balance', { symbol: wEther?.symbol }),
      }
    }
