...
export const CircleBox = styled.div<CircleProps>`
    ...
    align-items: center;
    width: ${({ width, showDots }) => showDots && width ? `calc(${width} + 34vw)` : ''};
...
export const BgCircleIcon = styled.img`
    width: 100%;
    height: 100%;
`
...
`
export const CenterCircleIcon = styled.img`
    width: 100%;
    height: 100%;
`
...
const Circle: React.FC<CircleProps> = ({ maxWidth, width, height, isShow, cursor, children, isAnimation, showDots }) => {
    ...
    const E3CircleIcon = isAnimation ? AnimationCenterCircleIcon : CenterCircleIcon;
    return (
        <CircleBox isShow={isShow} height={height} showDots={showDots} width={width}>
            <E2Circle width={width} height={height} maxWidth={maxWidth}>
                <E2CircleIcon src="/images/bg_cricle.svg" />
            </E2Circle>
            <E3Circle width={width} height={height} cursor={cursor} maxWidth={maxWidth}>
                <E3CircleIcon src="/images/center_cricle.svg" />
            </E3Circle>
