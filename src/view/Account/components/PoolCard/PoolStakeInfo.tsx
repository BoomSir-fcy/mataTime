    ...
    <Box>
        ...
        <Flex alignItems='center' flex='1'>
          ...
          <Box ml='8px'>
            <Text fontSize='14px' color='textTips'>
              {t('Your staked')} {depositSymbol}
            </Text>
            {stakeAmount.isFinite() ? (
              <Text bold color='white_black'>
                {dispalyStakeAmount}
              </Text>
            ) : (
              <Skeleton />
      ...
      <Flex mt='16px' justifyContent='space-between' alignItems='center'>
        <Flex alignItems='center' flex='1'>
          ...
          <Box ml='8px'>
            <Text fontSize='14px' color='textTips'>
              {t('Rewards')} {rewardToken0Symbol}
            </Text>
            {token0UnclaimedRewards.isFinite() ? (
              <Text bold>{dispalyToken0Rewards}</Text>
            ) : (
              <Skeleton />
            )}
          </Box>
        ...
        <Flex justifyContent='flex-end' alignItems='center' flex='1'>
          <Box mr='8px'>
            <Text fontSize='14px' textAlign='right' color='textTips'>
              {t('Rewards')} {rewardToken1Symbol}
            </Text>
