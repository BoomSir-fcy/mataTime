...
const ReceiveButton = styled(Button)<{ disabled: boolean }>`
  ...
  background: ${({ theme, disabled }) =>
    disabled ? theme.colors.borderColor : theme.colors.success};
`;

const MissionCard: React.FC<{ info: TaskInfo }> = ({ info }) => {
