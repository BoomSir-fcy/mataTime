...
export const darkColors: Colors = {
  ...
  tabsShadows: '0px -6px 8px 0px rgba(255, 255, 255, 0.15)',
  tabsAction: '#FFF',
  tabsCurrentBackground: '#131314',
  inputSelect: '#343434',
